...
export default {
  ...
  user: {
    ...
    // id: 2
    helper2Data: Helpers.createHelper(2)
  },
  ...
  auth: {
    ...
    helper2AuthData: Helpers.createAuth(
      2,
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjIsImNyZWF0ZURhdGUiOiIyMDE5LTA2LTEzVDAwOjQxOjM5LjUwMloiLCJpYXQiOjE1NjAzODY0OTl9.Eon0E2ehxWjoxTzASc-WVcXFeaZKgPLfLndjdKl76PQ'
    )
  }
}
